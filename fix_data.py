...
def fix_sells():
    """اصلاح sells.csv: محدود کردن profit_percent به ۲۰۰"""
...
def main():
    print("="*60)
    print("🛠️ شروع اصلاح داده‌های موجود")
    print("="*60)
    ...
    print("⚠️ لطفاً برای اطمینان، فایل‌های CSV را بررسی کنید.")
